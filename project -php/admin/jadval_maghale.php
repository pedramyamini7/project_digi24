...
<div class="content-wrapper digi-products-page">
    ...
    <div class="digi-products-top">
        ...
        <div class="digi-products-title">
            ...
            <p>
                مدیریت، مشاهده، ویرایش و حذف مقالات سایت
            </p>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="digi-actions">
                            ...
                            <a
                                    href="../maghalat-dakhel.php?id=<?php echo $row['id']; ?>"
                                    class="digi-action digi-action-view"
                            >
                            ...
                            <a
                                    href="edit_maghale.php?id=<?php echo $row['id']; ?>"
                            ...
                            <a
                                    href="del_maghale.php?id=<?php echo $row['id']; ?>"
