...
// =====================================================
// فقط محصولات اصلی را دریافت می‌کنیم
// چون در محصول اصلی:
// id = project_id
// =====================================================
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="digi-actions">
                            ...
                            <a
                                    href="edit_camera_film.php?id=<?php echo $row['id']; ?>"
                            ...
                            <a
                                    href="del_camera_film.php?id=<?php echo $row['id']; ?>"
