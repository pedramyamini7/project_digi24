...
if (isset($_POST['add_favorite'])) {
    ...
    if ($favorite_id > 0) {
        ...
        if (
            !isset($_SESSION['favorites_var']) ||
            !is_array($_SESSION['favorites_var'])
        ) {

            $_SESSION['favorites_var'] = [];
        }
        ...
        if (
            ...
            $_SESSION['favorites_var'] = array_values(
                array_diff(
                    $_SESSION['favorites_var'],
                    [$favorite_id]
                )
            ...
            $_SESSION['favorites_var'][] = $favorite_id;
        }
    }
...
?>
    ...
    <style>
        ...
        /* =====================================================
           این CSS را دقیقاً همان CSS فایل اصلی نگه دار
           چون ظاهر باید دقیقاً مثل projects باشد
        ===================================================== */
                    ...
                    <div class="d24p-buy-row d24p-buy-favorite-row">
                        ...
                        >
                            ...
                            <input
                                    type="hidden"
                                    name="id"
                                    value="var_<?php echo (int) $product['id']; ?>"
                            >
