...
/* =====================================================
   علاقه مندی های projects_jan
   کاملاً جدا از products / projects / projects_film
===================================================== */
...
if (isset($_POST['add_favorite'])) {
    ...
    if ($favorite_id > 0) {
        ...
        if (
            !isset($_SESSION['favorites_jan']) ||
            !is_array($_SESSION['favorites_jan'])
        ) {

            $_SESSION['favorites_jan'] = [];
        }
        ...
        if (
            ...
            $_SESSION['favorites_jan'] = array_values(
                array_diff(
                    $_SESSION['favorites_jan'],
                    [$favorite_id]
                )
            ...
            $_SESSION['favorites_jan'][] = $favorite_id;
        }
    }
...
$result_project_rows = mysqli_query($conn, $sql_project_rows);
...
while ($row = mysqli_fetch_assoc($result_project_rows)) {
...
<main class="container-fluid d24p-main overflow-visible">

    ```
    <!-- مسیر صفحه -->

    <div class="d24p-breadcrumb overflow-visible">
