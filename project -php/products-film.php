...
/* =====================================================
   علاقه مندی های FILM - افزودن / حذف
===================================================== */
...
if (isset($_POST['add_favorite'])) {
    ...
    if ($favorite_id > 0) {
        ...
        // فقط مخصوص projects_film
        if (
            !isset($_SESSION['favorites_film']) ||
            !is_array($_SESSION['favorites_film'])
        ) {

            $_SESSION['favorites_film'] = [];
        }


        /*
         * اگر محصول قبلاً در علاقه مندی های فیلم باشد
         * آن را حذف می کنیم
         */
        if (
            in_array(
            ...
            $_SESSION['favorites_film'] = array_values(
                array_diff(
                    $_SESSION['favorites_film'],
                    [$favorite_id]
                )
         ...
         */
            ...
            $_SESSION['favorites_film'][] = $favorite_id;
        }
    }
