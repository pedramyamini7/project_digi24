...
/* =====================================================
   علاقه مندی های projects_lenz
   کاملاً جدا از سایر محصولات
===================================================== */
...
if (isset($_POST['add_favorite'])) {
    ...
    if ($favorite_id > 0) {
        ...
        if (
            !isset($_SESSION['favorites_lenz']) ||
            !is_array($_SESSION['favorites_lenz'])
        ) {

            $_SESSION['favorites_lenz'] = [];
        }
        ...
        if (
            ...
            $_SESSION['favorites_lenz'] = array_values(
                array_diff(
                    $_SESSION['favorites_lenz'],
                    [$favorite_id]
                )
            ...
            $_SESSION['favorites_lenz'][] = $favorite_id;
        }
    }
