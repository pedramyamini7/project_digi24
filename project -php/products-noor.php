...
if (isset($_POST['add_favorite'])) {
    ...
    if ($favorite_id > 0) {
        ...
        if (
            !isset($_SESSION['favorites_noor']) ||
            !is_array($_SESSION['favorites_noor'])
        ) {

            $_SESSION['favorites_noor'] = [];
        }
        ...
        if (
            ...
            $_SESSION['favorites_noor'] = array_values(
                array_diff(
                    $_SESSION['favorites_noor'],
                    [$favorite_id]
                )
            ...
            $_SESSION['favorites_noor'][] = $favorite_id;
        }
    }
                    ...
                    <div class="d24p-buy-row d24p-buy-favorite-row">
                        ...
                        >
                            ...
                            <input
                                    type="hidden"
                                    name="id"
                                    value="noor_<?php echo (int) $product['id']; ?>"
                            >
