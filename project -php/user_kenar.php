...
<aside
        class="d24-sidebar"
        style="border-radius: 20px; right: 20px; border:solid 1px rgba(0,0,0,0.06);"
>
    ...
    <div class="d24-logo overflow-visible">

        <div class="d24-logo-name overflow-visible">
            DIGI24
        </div>
    ...
    <div class="d24-profile">

        <div class="d24-avatar">
        ...
        <div class="d24-profile-name overflow-visible">
    ...
    <nav class="d24-menu">
        ...
        <a
                href="user.php"
                class="<?php echo $current_page == 'user.php' ? 'active' : ''; ?>"
        >

            <span class="d24-menu-icon">
                🏠
            </span>
